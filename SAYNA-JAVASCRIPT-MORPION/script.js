...
let selectionX = document.getElementById('selectionX')
let selectionO = document.getElementById('selectionO')
let pion , pionAdverse ;
let reponseJeu = document.getElementById('reponseJeu')
let h1ReponseJeu = reponseJeu.querySelector('h1')
...
function youWin() {
        for (let i = 0; i < reponsePossible.length; i++) {
                if (tableauX.includes(reponsePossible[i][0]) && tableauX.includes(resultatPossible[i][1]) && tableauX.includes(resultatPossible[i][2])) {

                        h1ReponseJeu.textContent = 'you win'
                        reponseJeu.style.display = 'flex'
...
function youLose() {
        for (let i = 0; i < reponsePossible.length; i++) {
                if (tableauO.includes(resultatPossible[i][0]) && tableauO.includes(resultatPossible[i][1]) && tableauO.includes(resultatPossible[i][2])) {
                        h1ReponseJeu.textContent = 'you lose'
                        reponseJeu.style.display = 'flex'
...
// selection de l'emplacement du pion de l'ordi 
function choixOrdi() {
        for (let i = 0; i < 9; i++) {
